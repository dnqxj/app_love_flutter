              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text("100",style: TextStyle(fontSize: 26, color: _themeColor, fontWeight: FontWeight.bold)),
                      SizedBox(width: 5,),
                      Text("天"),
                    ],
                  ),
                  SizedBox(height: 10,),
                  Text("距离恋爱纪念日", style: TextStyle(fontSize: 16, color: Colors.black54))
                ],
              ),
            ),
            Expanded(
        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Text("姓名：", style: _valueStyle,),
                  Text("刘亦菲")
                ],
              ),
              Row(
                children: [
                  Text("生日：", style: _valueStyle,),
                  Text("1995-05-12")
                ],
              )
            ],
          ...
          Row(
            children: [
              Text("距离纪念日还有", style: _valueStyle,),
              Text("100", style: TextStyle(color: _themeColor),),
              Text("天", style: _valueStyle,)
            ],
          ),
          SizedBox(height: 10,),
          Divider(height: 1,)
